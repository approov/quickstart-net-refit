...
You can see a [worked example](https://github.com/approov/quickstart-maui-refit/blob/main/SHAPES-EXAMPLE.md#shapes-app-with-secrets-protection) for the Shapes app.
